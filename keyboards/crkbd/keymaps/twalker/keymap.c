...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MAC] = LAYOUT(
  //,--------+--------+--------+--------+--------+--------.                                   ,--------+--------+--------+--------+--------+--------.
      _______,  UC_WIN, _______, _______, DM_PLY1, DM_PLY2,                                     _______,  UC_LNX, MAC_USER, _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------|                                   |--------+--------+--------+--------+--------+--------|
      _______,  UC_MAC, _______, DM_RSTP, _______, _______,                                    UC(L'–'), _______, MAC_EMAIL, _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------|                                   |--------+--------+--------+--------+--------+--------|
